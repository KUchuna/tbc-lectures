  ...
  return (
    user && (
      <div className='flex flex-col md:pl-[50px] pl-[16px] pb-[200px]'>
        <h1 className='md:text-4xl text-2xl text-center md:text-left uppercase font-bold md:mb-[50px] mb-[25px]'>{scopedT('title')}</h1>
        <div>
          ...
          <div className='flex flex-col gap-5'>
            ...
            <div className='flex flex-col gap-2'>
              <span className='font-bold text-lg text-gray-600 dark:text-slate-50'>{scopedT('email')}</span>
