...
export default function ServiceSection() {
    return (
        <section className="section-container parent-flex-column-center" id="service-section">
            <div className='parent-max-width'>
                <div className="section-short-title-link-container"> 
                    ...
                    <Link to='/services'><span className="section-link">View all services<img src={linkarrow} alt='' /></span></Link>
                </div>
