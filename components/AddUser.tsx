    ...
    return (
        <div>
            ...
            <form action={createUserAction} className="translate-x-[-50%] left-[50%] rounded-xl h-[400px] flex flex-col gap-4 w-[500px] text-black absolute bg-slate-700 p-10 py-20">
                        <input type="text" name="name" className='h-[40px] rounded-lg dark:bg-slate-400 px-3 text-lg text-white outline-none'/>
                        <input type="text" name="email" className='h-[40px] rounded-lg dark:bg-slate-400 px-3 text-lg text-white outline-none'/>
                        <input type="text" name="age" className='h-[40px] rounded-lg dark:bg-slate-400 px-3 text-lg text-white outline-none'/>
