...
export default function AddService() {
    ...
    return (
        ...
        {open && 
            <form action={addServiceAction} className="z-10 translate-x-[-50%] left-[50%] rounded-xl h-fit flex flex-col gap-4 w-[500px] text-black absolute bg-slate-700 p-10 py-20">
                        ...
                        <textarea name="full_description" placeholder='Enter full description' className='min-h-[500px] rounded-lg dark:bg-slate-600 px-3 text-lg outline-none'></textarea>
